...
Rewrote src/app/school-plan/page.tsx. Two-card section: Set to Open (yellow accent) and Connect with Community (blue accent) using ColoredBorderCard. Support-mission section with child classroom image, payment logos, Donate CTA, and geometric SVG decorative accents.

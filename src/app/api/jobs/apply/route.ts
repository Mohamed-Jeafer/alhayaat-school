...
export async function POST(req: NextRequest) {
  ...
  if (!connStr) {
    console.error('[jobs/apply] AZURE_STORAGE_CONNECTION_STRING not set');
  ...
  try {
    ...
    console.error('[jobs/apply] Azure Blob upload error:', err);
    return NextResponse.json(

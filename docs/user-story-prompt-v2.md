...
## PROJECT CONTEXT
Al-Hayaat School — migrated from Webflow to Next.js 15; production is **https://www.alhayaat.ca/** (Azure). The Webflow export in-repo and optional **https://al-hayaat.webflow.io/** remain useful for design parity.
